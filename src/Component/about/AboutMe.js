...
const colors = tokens(theme.palette.mode);
    return(
        <Box sx={{ //height:"100vh" ,
            ...
            sx={{ textAlign:"center",color:colors.primary[300],padding:'15px 0 20px',
            margin:'20px 0 -20px',fontSize:15,}}> Get To Know </Typography>
            <Typography  variant="h2"  sx={{textAlign:'center',  padding:'15px 0 50px 0',
        ...
        style={{background:'#31353b',borderRadius:'30px',transition:'1s'}}/>
                ...
                sx={{width: '100%',display:"flex",justifyContent: "space-around",alignItems:'center',gap:1 ,flexWrap:'wrap', 
                    ...
                    <Box >
                        ...
                        I know three languages  <span style={{color: colors.primary[400]}}> [ Arabic ,English ,Russian ] </span>
                        </Typography> 
                    </Box>
                    <Button ref={button} id='ofay'  className='buttonPro'  
                    sx={{ marginLeft:2, fontSize:"11px" ,width: "25%",height: "44px", 
                    mt:2,padding:2,color: 'white', background:colors.primary[400]}}
